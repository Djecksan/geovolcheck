...
@property (strong, nonatomic) GEOLocationManager *locationTracker;
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [ETCoreDataManager sharedManager];
    ...
    if ([launchOptions objectForKey:UIApplicationLaunchOptionsLocationKey]) {
        ...
        notification.alertBody = [NSString stringWithFormat:@"Попытка запустить обновление локации"];
